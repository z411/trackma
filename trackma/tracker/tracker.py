...
class TrackerBase(object):
    ...
    def _get_playing_show(self, filename):
        ...
        if filename:
            ...
            if playing_show:
                (playing_show, show_ep_start) = utils.redirect_show(
                    (playing_show, show_ep_start), self.redirections, self.list)

                return (utils.TRACKER_PLAYING, (playing_show, show_ep_start))
            else:
                # Show not in list
