...
class libmal(lib):
    ...
    mediatypes['anime'] = {
        ...
        'score_max': 10,
        'score_step': 1,
        'search_methods': [utils.SearchMethod.KEYWORD, utils.SearchMethod.SEASON],
    }
    mediatypes['manga'] = {
        'has_progress': True,
        'can_add': True,
        ...
        'score_max': 10,
        'score_step': 1,
        'search_methods': [utils.SearchMethod.KEYWORD],
    }
        ...
        while url:
            ...
            for item in data['data']:
                ...
                shows[showid].update({
                    ...
                    'status': utils.Status.find(item['node']['status']),
    ...
    def search(self, criteria, method):
        ...
        if method == utils.SearchMethod.KEYWORD:
    ...
    def _parse_info(self, item):
        ...
        info.update({
            ...
            'type': utils.Type.find(item['media_type']),
    ...
    def _translate_status(self, orig_status):
        return utils.Status.find(orig_status)
