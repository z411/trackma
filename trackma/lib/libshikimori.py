...
class libshikimori(lib):
    ...
    def _translate_status(status_str):
        ...
        return utils.Status.find(status_str)

    @staticmethod
    def _translate_type(type_str):
        if type_str.startswith('tv_'):
            return utils.Type.TV
        return utils.Type.find(type_str)
    ...
    def fetch_list(self):
        ...
        for item in data:
            ...
            show.update({
                ...
                'type': self._translate_type(item[self.mediatype]['kind']),
                'status': self._translate_status(item[self.mediatype]['status']),
                'my_id': item['id'],
    ...
    def search(self, criteria, method):
        ...
        for item in data:
            ...
            show.update({
                ...
                'type': self._translate_type(item['kind']),
